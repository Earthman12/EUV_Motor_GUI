...
class EUVGUI(object):
    ...
    def __init__(self):
        ...
        #Controller Model
        self.modelLabel = tk.Label(text = "Controller Model: " + self.OmsLib.model)
...
class Oms(object):
    ...
    def __init__(self, gui):
        ...
        self.gui = gui
        #OMS LIBRARY
        self.lib = ct.CDLL("./Important_Files/PCIxLibrary/lib/Win10/x64/OmsPciMc.dll")
        #OMS HANDLE, THIS MAY NEED TO BE CHANGED DEPENDING ON CARD SLOT
        self.handle = self.lib.GetOmsHandle("OmsPci1")
        #CONTROLLER LOG
        self.log = ""
