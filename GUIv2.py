...
class EUVGUI(object):
    ...
    def __init__(self):
        ...
        #C Library Object
        self.OmsController = Oms(self)
        #Status Message
        self.guiLog = self.OmsController.log
        ...
        #Controller Model
        self.modelLabel = tk.Label(text = "Controller Model: " + self.OmsController.model)
        ...
        self.commandButton = tk.Button(text = "Send", command = lambda :[self.OmsController.sendCommand(self.commandSend), self.updateLog()])
        ...
        self.resetButton = tk.Button(text = "Reset Controller", command = lambda : [self.OmsController.resetController(), self.updateLog()])
...
#--------------------------------------------------------------------------------------------------
    ...
    def updateLog(self):
        self.logLabel.config(text = "Controller Log: " + self.OmsController.getLog())
...
class Oms(object):
    ...
    def __init__(self, gui):
        ...
        self.gui = gui
        #OMS LIBRARY
        self.lib = ct.CDLL("./Important_Files/MAXkSoftware/MAXkWebsiteWindows10/lib/Win10/x64/OmsMAXkMC.dll")
        #OMS HANDLE, THIS MAY NEED TO BE CHANGED DEPENDING ON CARD SLOT
        self.handle = self.lib.GetOmsHandle("OmsMAXk1")
        #CONTROLLER LOG
        self.log = ""
...
#--------------------------------------------------------------------------------------------------
    ...
    def getModel(self):
        ...
        self.lib.SendAndGetString(self.handle, "wy", model)
